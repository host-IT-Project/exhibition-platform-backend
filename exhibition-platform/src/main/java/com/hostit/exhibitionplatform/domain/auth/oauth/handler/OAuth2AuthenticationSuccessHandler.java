package com.hostit.exhibitionplatform.domain.auth.oauth.handler;
...
import static com.hostit.exhibitionplatform.domain.auth.exception.AuthErrorCode.INVALID_LOGIN_REDIRECT_URI;
...
//            throw new IllegalArgumentException("Sorry! We've got an Unauthorized Redirect URI and can't proceed with the authentication");
            throw new InvalidLoginRedirectUriException(INVALID_LOGIN_REDIRECT_URI);
        }
